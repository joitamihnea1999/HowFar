import { legendColor, LEGEND_MINUTES, MODE_LABEL } from "@/features/isochrones/isochrone-view";
import type { Mode } from "@/features/map/selection-flow";

/**
 * Selected-address card: the resolved label + per-mode ring legend, or the
 * failure message. Pure presentation of the selection machine's state.
 */
...
export default function SelectionCard({ label, message, mode }: SelectionCardProps) {
